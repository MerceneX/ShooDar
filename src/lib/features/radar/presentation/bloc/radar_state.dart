...
class Loaded extends RadarState {
  ...
  Loaded(this.radars, this.location, this.controller, this.initialCameraPosition, this.isUserLoggedIn);

  @override
  List<Object> get props => [radars, location, controller, isUserLoggedIn];
}
